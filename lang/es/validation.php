...
return [
    ...
    */
    ...
    'required_with'        => 'El campo :attribute es obligatorio cuando :present is present.',
    ...
    'starts_with'          => 'El campo :attribute debe empezar con uno de los valores: :values.',
    ...
    'url'                  => 'El formato de fecha :attribute no es válido.',
    ...
    | convention "attribute.rule" to name the lines. This ensures quick year
    | finding specific custom language file translations.
    |
    */

    'custom' => [
        'email' => [
            'unique' => 'Este correo electrónico ya está registrado en Eatly.',
        ],
        'password' => [
    ...
    |--------------------------------------------------------------------------
    |
    | The following language lines are used attribute our placeholders
    | with clear Spanish names instead of field keys.
    |
    */
